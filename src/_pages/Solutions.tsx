        ...
        <div className="space-y-3">
          <div className="text-[13px] leading-[1.4] text-gray-100 bg-white/5 rounded-md p-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                <strong>Time:</strong> <MarkdownRenderer content={formattedTimeComplexity} className="inline" />
              </div>
            </div>
          </div>
          <div className="text-[13px] leading-[1.4] text-gray-100 bg-white/5 rounded-md p-3">
            <div className="flex items-start gap-2">
              <div className="w-1 h-1 rounded-full bg-blue-400/80 mt-2 shrink-0" />
              <div>
                <strong>Space:</strong> <MarkdownRenderer content={formattedSpaceComplexity} className="inline" />
              </div>
            </div>
          </div>
        </div>
