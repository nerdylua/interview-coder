...
export function initializeIpcHandlers(deps: IIpcHandlerDeps): void {
  ...
  ipcMain.handle("get-screenshot-mode", () => {
    return deps.getScreenshotMode()
  })

  ipcMain.handle("set-screenshot-mode", (_event, mode: "full" | "left" | "right") => {
    deps.setScreenshotMode(mode)
    return { success: true }
  })
